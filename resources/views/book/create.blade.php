                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('book.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="kode_buku" type="text" class="form-control @error('kode_buku') is-invalid @enderror" name="kode_buku" value="{{ old('kode_buku') }}" required autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                value="{{ old('judul_buku') }}" required autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="penulis" type="text" class="form-control @error('penulis') is-invalid @enderror" name="penulis" value="{{ old('penulis') }}" required autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="thn_terbit" type="date" class="form-control @error('thn_terbit') is-invalid @enderror" name="thn_terbit" value="{{ old('thn_terbit') }}" required autofocus>
