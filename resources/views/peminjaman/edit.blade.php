...
<div class="container">
    <div class="row ">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Edit Data Peminjaman Buku</div>
                ...
                <form method="POST" action="{{ route('peminjaman.update', $peminjaman->id) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                @foreach ($anggotum as $item)
                                    <option value="{{ old('anggota_id',$item->id) }}">{{ old('anggota_id',$item->nama_anggota) }}</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                @foreach ($petuga as $item)
                                    <option value="{{ old('petugas_id',$item->id) }}">{{ old('petugas_id',$item->nama_petugas) }}</option>
                        ...
                        <div class="row mb-3">
                            <label for="buku_id" class="col-md-4 col-form-label ">Rak Buku</label>

                            <div class="col-md-6">
                                <select name="buku_id" id="buku_id" class="form-select" aria-label="Default select example">
                                @foreach ($book as $item)
                                <option value="{{ old('buku_id',$item->id) }}">{{ old('buku_id',$item->judul_buku) }}</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                value="{{ old('tgl_pinjam',$peminjaman->tgl_pinjam) }}" required autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                value="{{ old('tgl_kembali', $peminjaman->tgl_kembali) }}" required autofocus>
