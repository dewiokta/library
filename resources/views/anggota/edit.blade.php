    ...
    <div class="row ">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                <form method="POST" action="{{ route('anggota.update', $anggotum->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="nama_anggota" type="text" class="form-control @error('nama_anggota') is-invalid @enderror" name="nama_anggota" 
                                value="{{ old('nama_anggota', $anggotum->nama_anggota) }}" required autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select name="jenis_kelamin" id="jenis_kelamin" class="form-select" aria-label="Default select example">
                                    <option value="{{ old('jenis_kelamin', $anggotum->jenis_kelamin) }}">{{ old('jenis_kelamin', $anggotum->jenis_kelamin) }}</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                value="{{ old('no_telp', $anggotum->no_telp) }}" required autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                value="{{ old('alamat',$anggotum->alamat) }}" required autofocus>
